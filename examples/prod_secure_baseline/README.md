...
- [outputs.tf](https://github.com/EspenAlbert/terraform-mongodbatlas-project/blob/v0.0.1/examples/prod_secure_baseline/outputs.tf)
- [variables.tf](https://github.com/EspenAlbert/terraform-mongodbatlas-project/blob/v0.0.1/examples/prod_secure_baseline/variables.tf)
- [versions.tf](https://github.com/EspenAlbert/terraform-mongodbatlas-project/blob/v0.0.1/examples/prod_secure_baseline/versions.tf)
